...
int rb_start_sniffing () {
    ...
    logfile=fopen("dsniff_log.txt","w");
...
void Init_sniffer(void) {
  DEBUG_PRINT("Init_sniffer");

  /* define class Packet */
  sniff = rb_define_class_under(reap, "PSniff", rb_cObject);
  rb_define_singleton_method(sniff, "start_sniffing", rb_start_sniffing, 0);
}
